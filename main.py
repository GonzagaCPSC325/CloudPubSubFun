...
TOPIC_PATH = "projects/cpsc325cloudfunctionfun-376417/topics/tweets"
...
def publish_tweet(tweet_dict):
    # need to pip install google-cloud-pubsub and import
    publisher_client = pubsub.PublisherClient() # this code
    # is going to authenticate with google_keys.json
